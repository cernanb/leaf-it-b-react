...
const Entrees = () => (
  <div style={{ textAlign: "left" }}>
    ...
    <div style={{ display: "flex", flexWrap: "wrap" }}>
      ...
      />
      <MenuItemCard
        title={"ISLAND CHARRED CHICKEN  or ISLAND CHARRED BEEF "}
        description={
          "Skinless/boneless chicken thighs or thinly sliced rib eye beef marinated in a mixture of a sweet, savory, and spicy sauce. Served with banana steamed rice and a side of sweet & sour cucumbers."
        }
      />
      <MenuItemCard
        title={"PERFECTION PORK "}
        description={
          "Twice cooked pork butt covered in a traditional sweet & salty sauce over white banana steeped rice. Served with banana steamed rice and a side of sweet & sour cucumbers."
        }
      />
      ...
      <MenuItemCard
        ...
        description={
          "Chewy noodles tossed with fried garlic, and accompanied with a sweet and savory sauce.  Garnished with green onions, red cabbage, and julienne carrots."
        }
      />
      <MenuItemCard
